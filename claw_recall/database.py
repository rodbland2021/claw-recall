"""
Claw Recall — Database Connection Management & Schema

Merged from db.py + setup_db.py. Provides:
- get_db() context manager for WAL-mode SQLite connections
- SCHEMA constant (full DDL)
- setup_database() for initial creation
- get_db_stats() for observability
"""
